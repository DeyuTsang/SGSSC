function [R,E,B, err, obj] =  Jlrs_slover_ls(X,D, k, Z1, Z2, Z3, beta, rho, Iter, method, Debug )
...
Q = R;
B = R'*R;
LB = diag(sum((abs(B)+abs(B'))/2,2)) - (abs(B)+abs(B'))/2;
